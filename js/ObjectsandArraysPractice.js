...
// // This is practice to help you with Objects and arrays. There are no test associated with
// //     these exercises, so you will need to test them manually.


// 1. Create a function called removeDuplicates that accepts an array of strings and
...
//
//
// 4. Create a function called whoIsPassing that accepts an array of objects, where each
// object is a student's name and class average (from 0 to 100). Your function will return ' +
// 'an array of objects where each object is a student's name and whether he/she is passing.
// Note that a class average of 60 and higher is passing.
//
// Examples
// var students = [
//     {
...
//     }
// ]
// 5. Create a function called dateStringToObject that accepts a date in the following
// string format "YYYY-MM-DD" and returns an object that contains month, day, and year properties.
//
// Examples
...
//
//
// 6.Create a function called reverseString that that accepts a string and returns a string with the
...
//
//
// 7. Create a function called numberInfo that accepts a number and returns an object with
// the properties isPositive, isEven, isZero. The properties should either be true or false based on
// if the parameter meets the criteria.
//
// Examples
// numberInfo(-1);
// // Should return the following
